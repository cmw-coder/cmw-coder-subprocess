...
var bomHandling = __webpack_require__(60),
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = __webpack_require__(61); // Lazy load all encoding definitions.
...
iconv.enableStreamingAPI = function enableStreamingAPI(stream_module) {
    ...
    var streams = __webpack_require__(80)(stream_module);
...
var stream_module;
try {
    stream_module = __webpack_require__(81);
} catch (e) {}
...
module.exports = {
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return (__webpack_require__(74).concat)(__webpack_require__(75)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return (__webpack_require__(78).concat)(__webpack_require__(79)) },
        encodeSkipVals: [
...
const iconv_lite_1 = __webpack_require__(57);
const promises_1 = __webpack_require__(88);
...
/******/ })()
;
//# sourceMappingURL=fileStructureAnalysisProcess.cjs.map