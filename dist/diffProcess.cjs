...
class Differ {
    ...
    diff_main(old, _new) {
        try {
            ...
            const ptr0 = passStringToWasm0(old, wasm.__wbindgen_export_0, wasm.__wbindgen_export_1);
            const len0 = WASM_VECTOR_LEN;
            const ptr1 = passStringToWasm0(_new, wasm.__wbindgen_export_0, wasm.__wbindgen_export_1);
            const len1 = WASM_VECTOR_LEN;
            wasm.differ_diff_main(retptr, this.__wbg_ptr, ptr0, len0, ptr1, len1);
